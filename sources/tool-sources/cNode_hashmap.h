...
#ifndef cVDDnodeInfo_hashmap_DEFINED
#define cVDDnodeInfo_hashmap_DEFINED
...
class cVDDnodeInfo_hashmap {
//--- Constructor
  public : cVDDnodeInfo_hashmap (void) ;

//--- Destructor
  public : virtual ~cVDDnodeInfo_hashmap (void) ;

//--- Search or insert
  public : cVDDnodeInfo * search_or_insert (const cVDDnodeInfo & inInfo,
                                            bool & outInsertionPerformed) ;

//--- Search
  public : cVDDnodeInfo * search (const cVDDnodeInfo & inInfo) ;
...
//--- No copy
  private : cVDDnodeInfo_hashmap (const cVDDnodeInfo_hashmap &) ;
  private : void operator = (const cVDDnodeInfo_hashmap &) ;
...
//--- Search
  public : inline cVDDnodeInfo * search (const cVDDnodeInfo & inInfo) ;
...
//--- Internal methods
  ...
  protected : cVDDnodeInfo * avltree_search (MyBlockavltree_element_for_collision * ioRootPointer,
                                                       const cVDDnodeInfo & inInfo) ;

  protected : cVDDnodeInfo * recursiveSearchOrInsert (MyBlockavltree_element_for_collision * & ioRootPointer,
                                                             const cVDDnodeInfo & inInfo,
                                                             bool & outExtension,
                                                             bool & outInsertionPerformed) ;
