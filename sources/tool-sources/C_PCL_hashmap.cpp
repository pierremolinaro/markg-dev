...
C_PCL_hashmap::cAllocInfo C_PCL_hashmap::smAllocInfo ;
...
void * C_PCL_hashmap::MyBlockavltree_element_for_collision::operator new (const size_t /*inByteSize*/) {
...
void C_PCL_hashmap::MyBlockavltree_element_for_collision::operator delete (void * inPtr) {
...
void C_PCL_hashmap::C_TreeForCollision::allocBlock (void) {
//--- Realloc block list ?
...
C_PCL_hashmap::C_TreeForCollision::C_TreeForCollision (void) :
mRoot (NULL) {
}
...
uint32_t C_PCL_hashmap::C_TreeForCollision::getAllocatedSizeInBytes (void) {
...
void C_PCL_hashmap::C_TreeForCollision::
...
C_PCL::cVDLnodeInfo * C_PCL_hashmap::C_TreeForCollision::
avltree_search (MyBlockavltree_element_for_collision * ioRootPointer,
                 const C_PCL::cVDLnodeInfo & inInfo) {
  C_PCL::cVDLnodeInfo * result = NULL ;
  if (ioRootPointer == NULL) {
    result = (C_PCL::cVDLnodeInfo *) NULL ;
  }else{
...
C_PCL::cVDLnodeInfo * C_PCL_hashmap::C_TreeForCollision::
search_or_insert (const C_PCL::cVDLnodeInfo & inInfo,
                  bool & outInsertionPerformed) {
  bool unused = false ;
...
C_PCL::cVDLnodeInfo * C_PCL_hashmap::C_TreeForCollision::
search (const C_PCL::cVDLnodeInfo & inInfo) {
...
uint32_t C_PCL_hashmap::C_TreeForCollision::internalRecursiveSweep (C_PCL_hashmap::MyBlockavltree_element_for_collision * inElement) {
...
uint32_t C_PCL_hashmap::C_TreeForCollision::sweepUnmarkedObjects (void) {
...
int32_t C_PCL_hashmap::C_TreeForCollision::
...
C_PCL_hashmap::C_PCL_hashmap (void) :
...
C_PCL::cVDLnodeInfo * C_PCL_hashmap::
search_or_insert (const C_PCL::cVDLnodeInfo & inInfo,
                  bool & outInsertionPerformed) {
...
uint32_t C_PCL_hashmap::sweepUnmarkedObjects (void) {
  uint32_t sweepedNodes = 0 ;
...
uint32_t C_PCL_hashmap::getMapSizeInBytes (void) const {
  return (uint32_t) (((size_t) mEntryCurrentCount) * sizeof (C_TreeForCollision)) ;
}

//---------------------------------------------------------------------------*

void C_PCL_hashmap::reallocMap (const int32_t inNewSize) {
...
void C_PCL_hashmap::unmarkAllObjects (void) {
  for (size_t i=0 ; i<mEntryCurrentCount ; i++) {
...
int32_t C_PCL_hashmap::getMarkedNodesCount (void) const {
  int32_t count = 0 ;
  for (size_t i=0 ; i<mEntryCurrentCount ; i++) {
