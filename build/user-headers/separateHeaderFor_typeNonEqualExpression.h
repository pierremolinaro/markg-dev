...
//--------------------------------------------------------------------------------------------------
//
// Phase 2: pointer class for @typeNonEqualExpression class
//
//--------------------------------------------------------------------------------------------------

class cPtr_typeNonEqualExpression : public cPtr_typePreconditionExpression {
...
//--------------------------------- Initializers
  public: void typeNonEqualExpression_init_21__21__21_ (const class GGS_uint & inOperand0,
...
//--- Constructor
  public: cPtr_typeNonEqualExpression (const GGS_uint & in_mVar,
