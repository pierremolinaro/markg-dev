...
//--------------------------------- Initializers
  public: void typeInfOrEqualExpression_init_21__21__21_ (const class GGS_uint & inOperand0,
...
//--- Default constructor
  public: cPtr_typeInfOrEqualExpression (Compiler * inCompiler COMMA_LOCATION_ARGS) ;

//--- Constructor
  public: cPtr_typeInfOrEqualExpression (const GGS_uint & in_mVar,
