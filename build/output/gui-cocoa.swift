...
void enterOptions (NSMutableArray * ioBoolOptionArray,
  ...
  enterOptionsFor_spec_5F_options (ioBoolOptionArray, ioUIntOptionArray, ioStringOptionArray, ioStringListOptionArray) ;
...
fileprivate let gPopUpData_0_spec_5F_scanner : [[UInt16]] = [
...
class SWIFT_Tokenizer_0_spec_scanner : SWIFT_Lexique_spec_scanner, SWIFT_Tokenizer_Protocol {
...
//- (NSString *) textMacroContentAtIndex: (const UInt32) inIndex ;
  ...
  func popupListData () -> [[UInt16]] {
    return gPopUpData_0_spec_5F_scanner
  }
...
/* @implementation OC_Tokenizer_0_spec_scanner
...
func tokenizerFor (extension inExtension : String) -> SWIFT_Tokenizer_Protocol? {
  ...
  if inExtension == "mg" {
    result = SWIFT_Tokenizer_0_spec_scanner ()
  }
  return result
}
...
func tokenizers () -> [SWIFT_Tokenizer_Protocol] {
  return [
    SWIFT_Tokenizer_0_spec_scanner ()
  ]
}
