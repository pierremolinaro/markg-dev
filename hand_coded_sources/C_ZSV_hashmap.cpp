...
uint32_t C_ZSV_hashmap::getAllocatedSizeInBytes (void) {
...
uint32_t C_ZSV_hashmap::C_TreeForCollision::internalRecursiveSweep (C_ZSV_hashmap::MyBlockavltree_element_for_collision * inElement) {
...
uint32_t C_ZSV_hashmap::C_TreeForCollision::sweepUnmarkedObjects (void) {
...
int32_t C_ZSV_hashmap::C_TreeForCollision::
...
uint32_t C_ZSV_hashmap::sweepUnmarkedObjects (void) {
  uint32_t sweepedNodes = 0 ;
...
uint32_t C_ZSV_hashmap::getMapSizeInBytes (void) const {
...
int32_t C_ZSV_hashmap::getMarkedNodesCount (void) const {
  int32_t count = 0 ;
  for (int32_t i=0 ; i<mEntryCurrentCount ; i++) {
