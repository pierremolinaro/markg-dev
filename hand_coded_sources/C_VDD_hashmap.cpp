...
C_VDD_hashmap::cAllocInfo C_VDD_hashmap::smAllocInfo ;
...
void * C_VDD_hashmap::MyBlockavltree_element_for_collision::operator new (const size_t /*inByteSize*/) {
...
void C_VDD_hashmap::MyBlockavltree_element_for_collision::operator delete (void * inPtr) {
...
void C_VDD_hashmap::C_TreeForCollision::allocBlock (void) {
//--- Realloc block list ?
...
C_VDD_hashmap::C_TreeForCollision::C_TreeForCollision (void) :
mRoot (NULL) {
}
...
uint32_t C_VDD_hashmap::getAllocatedSizeInBytes (void) {
...
void C_VDD_hashmap::C_TreeForCollision::
...
C_VDD::cVDDnodeInfo * C_VDD_hashmap::C_TreeForCollision::
search_or_insert (const C_VDD::cVDDnodeInfo & inInfo,
                  bool & outInsertionPerformed) {
  bool unused = false ;
...
C_VDD::cVDDnodeInfo * C_VDD_hashmap::C_TreeForCollision::
search (const C_VDD::cVDDnodeInfo & inInfo) {
...
uint32_t C_VDD_hashmap::C_TreeForCollision::internalRecursiveSweep (C_VDD_hashmap::MyBlockavltree_element_for_collision * inElement) {
...
uint32_t C_VDD_hashmap::C_TreeForCollision::sweepUnmarkedObjects (void) {
...
int32_t C_VDD_hashmap::C_TreeForCollision::
...
C_VDD_hashmap::C_VDD_hashmap (void) :
...
C_VDD::cVDDnodeInfo * C_VDD_hashmap::
search_or_insert (const C_VDD::cVDDnodeInfo & inInfo,
                  bool & outInsertionPerformed) {
  uintptr_t hashCode = inInfo.getHashCodeForMap () ;
  hashCode %= (uintptr_t) mEntryCurrentCount ;
...
uint32_t C_VDD_hashmap::sweepUnmarkedObjects (void) {
  uint32_t sweepedNodes = 0 ;
...
uint32_t C_VDD_hashmap::getMapSizeInBytes (void) const {
...
void C_VDD_hashmap::unmarkAllObjects (void) {
  for (int32_t i=0 ; i<mEntryCurrentCount ; i++) {
...
int32_t C_VDD_hashmap::getMarkedNodesCount (void) const {
  int32_t count = 0 ;
  for (int32_t i=0 ; i<mEntryCurrentCount ; i++) {
