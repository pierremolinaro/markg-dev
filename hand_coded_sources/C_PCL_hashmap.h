...
#ifndef C_PCL_hashmap_DEFINED
#define C_PCL_hashmap_DEFINED
...
class C_PCL_hashmap {
//--- Constructor
  public : C_PCL_hashmap (void) ;

//--- Destructor
  public : virtual ~C_PCL_hashmap (void) ;

//--- Search or insert
  public : C_PCL::cVDLnodeInfo * search_or_insert (const C_PCL::cVDLnodeInfo & inInfo,
                                                   bool & outInsertionPerformed) ;

//--- Search
  public : C_PCL::cVDLnodeInfo * search (const C_PCL::cVDLnodeInfo & inInfo) ;
...
//--- No copy
  private : C_PCL_hashmap (const C_PCL_hashmap &) ;
  private : void operator = (const C_PCL_hashmap &) ;
...
//--- Search
  public : inline C_PCL::cVDLnodeInfo * search (const C_PCL::cVDLnodeInfo & inInfo) ;
...
//--- Internal methods
  ...
  protected : C_PCL::cVDLnodeInfo * avltree_search (MyBlockavltree_element_for_collision * ioRootPointer,
                                                       const C_PCL::cVDLnodeInfo & inInfo) ;

  protected : C_PCL::cVDLnodeInfo * recursiveSearchOrInsert (MyBlockavltree_element_for_collision * & ioRootPointer,
                                                             const C_PCL::cVDLnodeInfo & inInfo,
                                                             bool & outExtension,
                                                             bool & outInsertionPerformed) ;
